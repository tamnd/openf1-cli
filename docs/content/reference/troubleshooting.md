...
Most of these come down to network reality or how openf1 serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

openf1 rate-limits like any public site. openf1 already paces
...
Where a surface is gated, openf1 reads a cookie or token you supply
...
`openf1`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what openf1 actually did
