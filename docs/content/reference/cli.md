...
```
openf1 <command> [arguments] [flags]
```

Run `openf1 <command> --help` for the full flag list on any command. This
...
a row here per operation you declare in `openf1/domain.go`.
