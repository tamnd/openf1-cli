---
title: "openf1"
description: "A command line for openf1."
heroTitle: "openf1, from the command line"
heroLead: "A command line for openf1. One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
openf1 links <path>           # the pages it links to, each addressable
openf1 serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading openf1 by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address openf1 as
  `openf1://` URIs and follow links across sites. See
